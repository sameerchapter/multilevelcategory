...
<section id="contact">
      <div class="section-content">
        <h1 class="section-header">Add<span class="content-header wow fadeIn " data-wow-delay="0.2s" data-wow-duration="2s"> Categories</span></h1>
        <h3>Assign parent category to your new category.</h3>
      </div>
